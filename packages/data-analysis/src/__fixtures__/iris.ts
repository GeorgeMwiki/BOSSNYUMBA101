/**
 * Iris dataset (Fisher 1936) — 150 samples × 4 features × 3 species.
 * Used to validate PCA: the first principal component on the
 * column-mean-centred matrix explains ~92 % of variance (raw covariance)
 * or ~73 % on the standardised matrix.
 *
 * Reference: Fisher, R. A. (1936). *The use of multiple measurements
 * in taxonomic problems.* Annals of Eugenics 7(2):179-188.
 * URL: <https://doi.org/10.1111/j.1469-1809.1936.tb02137.x>.
 * Date checked: 2026-05-27. Public-domain transcription via
 * UCI ML Repository.
 *
 * Features: [sepal length, sepal width, petal length, petal width] in cm.
 * Species labels: 0 = setosa, 1 = versicolor, 2 = virginica.
 */

export const IRIS_X: ReadonlyArray<readonly [number, number, number, number]> = [
