-- =============================================================================
-- Migration 0284 — Maintenance Crew Tasks + Pre-Shift Toolbox Talks
-- (renumbered from 0283 — the original 0283 slot was claimed by a
--  parallel sibling porter for `0283_oauth_action_approvals.sql`).
--
