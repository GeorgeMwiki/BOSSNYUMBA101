// @ts-nocheck FIXME(am3): drizzle-orm v0.36 pgEnum column narrowing — accepts only literal union in eq(); repo params arrive as string. Tracked upstream: drizzle-team/drizzle-orm#2389. Revisit after drizzle 0.37 widened overloads.
/**
