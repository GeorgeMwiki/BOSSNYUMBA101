 ...
 *     (the `bossnyumba.capabilities.what_can_you_do` + `bossnyumba.about` tools)
 *   - services/api-gateway/src/routes/public-marketing.router.ts (disclosure
 *     rule injection)
 *   - services/api-gateway/src/routes/brain.hono.ts (ditto)
 */
 ...
 *
 * Default (no override registered, or country = 'KE') returns the
 * base entry untouched — the canonical registry is KE-first.
 */
