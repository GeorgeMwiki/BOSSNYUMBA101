...
export const guatemalaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guatemala has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guatemalaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
