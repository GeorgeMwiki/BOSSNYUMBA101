...
export const denmarkScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'DK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Denmark has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const denmarkScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
