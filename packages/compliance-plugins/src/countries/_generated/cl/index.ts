...
export const chileScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Chile has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chileScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
