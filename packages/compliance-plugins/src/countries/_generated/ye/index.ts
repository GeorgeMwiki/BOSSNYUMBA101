...
export const yemenScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'YE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Yemen has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const yemenScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ye/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
