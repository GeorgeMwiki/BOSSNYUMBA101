...
export const seychellesScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Seychelles has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const seychellesScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
