...
export const congoDemocraticRepublicOfTheScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Congo, Democratic Republic of the has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const congoDemocraticRepublicOfTheScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cd/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
