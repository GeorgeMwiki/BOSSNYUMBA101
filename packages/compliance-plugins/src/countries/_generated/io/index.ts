...
export const britishIndianOceanTerritoryScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: British Indian Ocean Territory has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const britishIndianOceanTerritoryScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../io/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
