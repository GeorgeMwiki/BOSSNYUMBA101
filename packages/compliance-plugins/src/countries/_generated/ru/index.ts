...
export const russianFederationScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'RU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Russian Federation has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const russianFederationScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ru/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
