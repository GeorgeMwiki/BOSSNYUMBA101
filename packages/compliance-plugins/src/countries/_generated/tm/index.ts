...
export const turkmenistanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Turkmenistan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const turkmenistanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
