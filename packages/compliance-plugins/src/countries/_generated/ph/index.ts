...
export const philippinesScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Philippines has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const philippinesScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ph/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
