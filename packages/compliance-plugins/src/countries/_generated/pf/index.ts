...
export const frenchPolynesiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Polynesia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchPolynesiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
