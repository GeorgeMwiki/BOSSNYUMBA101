...
export const romaniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'RO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Romania has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const romaniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ro/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
