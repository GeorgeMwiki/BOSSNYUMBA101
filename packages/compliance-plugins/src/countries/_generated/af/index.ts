...
export const afghanistanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Afghanistan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const afghanistanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../af/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
