...
export const austriaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Austria has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const austriaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../at/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
