...
export const congoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Congo has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const congoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
