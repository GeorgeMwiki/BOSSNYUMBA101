...
export const vanuatuScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Vanuatu has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const vanuatuScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
