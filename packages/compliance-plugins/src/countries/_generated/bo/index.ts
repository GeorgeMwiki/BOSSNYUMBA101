...
export const boliviaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bolivia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const boliviaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bo/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
