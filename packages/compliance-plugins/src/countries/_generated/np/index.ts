...
export const nepalScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nepal has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nepalScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../np/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
