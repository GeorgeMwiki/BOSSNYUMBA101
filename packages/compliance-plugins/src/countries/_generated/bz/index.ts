...
export const belizeScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belize has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belizeScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
