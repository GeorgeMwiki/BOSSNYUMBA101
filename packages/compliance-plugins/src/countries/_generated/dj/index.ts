...
export const djiboutiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'DJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Djibouti has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const djiboutiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dj/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
