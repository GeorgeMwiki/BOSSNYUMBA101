...
export const zimbabweScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ZW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Zimbabwe has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const zimbabweScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../zw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
