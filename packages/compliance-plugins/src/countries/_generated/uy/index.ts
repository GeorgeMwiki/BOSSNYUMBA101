...
export const uruguayScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'UY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Uruguay has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const uruguayScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../uy/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
