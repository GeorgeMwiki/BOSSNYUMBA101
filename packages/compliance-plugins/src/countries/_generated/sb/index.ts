...
export const solomonIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Solomon Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const solomonIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sb/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
