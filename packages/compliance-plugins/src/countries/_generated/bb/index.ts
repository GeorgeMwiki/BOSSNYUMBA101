...
export const barbadosScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Barbados has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const barbadosScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bb/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
