...
export const mozambiqueScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mozambique has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mozambiqueScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
