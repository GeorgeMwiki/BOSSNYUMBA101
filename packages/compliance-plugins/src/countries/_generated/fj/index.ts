...
export const fijiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'FJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Fiji has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const fijiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fj/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
