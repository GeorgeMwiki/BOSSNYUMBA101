...
export const holySeeVaticanCityStateScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Holy See (Vatican City State) has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const holySeeVaticanCityStateScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../va/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
