...
export const kazakhstanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kazakhstan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kazakhstanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
