...
export const bermudaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bermuda has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bermudaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
