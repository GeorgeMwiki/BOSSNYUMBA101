...
export const haitiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Haiti has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const haitiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ht/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
