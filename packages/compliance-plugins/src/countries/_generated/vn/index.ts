...
export const vietNamScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Viet Nam has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const vietNamScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
