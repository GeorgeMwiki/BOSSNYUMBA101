...
export const faroeIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'FO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Faroe Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const faroeIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fo/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
