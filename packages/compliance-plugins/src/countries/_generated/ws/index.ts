...
export const samoaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'WS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Samoa has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const samoaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ws/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
