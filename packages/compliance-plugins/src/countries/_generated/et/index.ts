...
export const ethiopiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ET-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ethiopia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ethiopiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../et/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
