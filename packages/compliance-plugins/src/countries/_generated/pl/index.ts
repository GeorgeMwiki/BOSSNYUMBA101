...
export const polandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Poland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const polandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
