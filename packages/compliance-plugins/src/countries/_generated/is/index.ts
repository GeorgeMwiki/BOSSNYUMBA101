...
export const icelandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Iceland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const icelandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../is/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
