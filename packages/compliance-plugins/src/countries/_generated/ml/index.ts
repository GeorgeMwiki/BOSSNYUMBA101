...
export const maliScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ML-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mali has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maliScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ml/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
