...
export const hondurasScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Honduras has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hondurasScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
