...
export const burkinaFasoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Burkina Faso has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const burkinaFasoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
