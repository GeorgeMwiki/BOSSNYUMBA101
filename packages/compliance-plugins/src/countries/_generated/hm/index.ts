...
export const heardIslandAndMcdonaldIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Heard Island and McDonald Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const heardIslandAndMcdonaldIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
