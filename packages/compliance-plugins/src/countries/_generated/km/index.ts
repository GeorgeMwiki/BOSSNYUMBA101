...
export const comorosScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Comoros has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const comorosScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../km/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
