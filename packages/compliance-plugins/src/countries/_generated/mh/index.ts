...
export const marshallIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Marshall Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const marshallIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mh/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
