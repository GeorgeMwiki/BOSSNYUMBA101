...
export const angolaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Angola has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const angolaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ao/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
