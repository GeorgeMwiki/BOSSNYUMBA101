...
export const tajikistanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tajikistan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tajikistanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tj/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
