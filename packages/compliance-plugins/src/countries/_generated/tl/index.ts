...
export const timorLesteScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Timor-Leste has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const timorLesteScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
