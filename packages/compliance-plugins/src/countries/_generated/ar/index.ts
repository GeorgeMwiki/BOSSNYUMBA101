...
export const argentinaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Argentina has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const argentinaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ar/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
