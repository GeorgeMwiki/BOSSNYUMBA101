...
export const sriLankaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sri Lanka has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sriLankaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
