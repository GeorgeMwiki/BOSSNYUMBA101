...
export const panamaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Panama has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const panamaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pa/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
