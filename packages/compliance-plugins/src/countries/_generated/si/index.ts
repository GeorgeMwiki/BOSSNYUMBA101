...
export const sloveniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Slovenia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sloveniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../si/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
