...
export const papuaNewGuineaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Papua New Guinea has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const papuaNewGuineaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
