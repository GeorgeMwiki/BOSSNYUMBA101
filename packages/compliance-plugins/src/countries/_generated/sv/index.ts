...
export const elSalvadorScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: El Salvador has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const elSalvadorScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
