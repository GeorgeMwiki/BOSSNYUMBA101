...
export const unitedStatesMinorOutlyingIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'UM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: United States Minor Outlying Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const unitedStatesMinorOutlyingIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../um/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
