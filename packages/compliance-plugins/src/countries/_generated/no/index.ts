...
export const norwayScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Norway has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const norwayScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../no/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
