...
export const netherlandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Netherlands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const netherlandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
