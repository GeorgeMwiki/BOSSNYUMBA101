...
export const dominicaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'DM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Dominica has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const dominicaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
