...
export const niueScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Niue has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const niueScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
