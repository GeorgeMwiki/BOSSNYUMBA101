...
export const armeniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Armenia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const armeniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../am/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
