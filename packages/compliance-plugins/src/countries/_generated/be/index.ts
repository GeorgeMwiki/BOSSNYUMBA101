...
export const belgiumScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belgium has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belgiumScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../be/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
