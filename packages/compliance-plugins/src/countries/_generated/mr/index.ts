...
export const mauritaniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mauritania has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mauritaniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
