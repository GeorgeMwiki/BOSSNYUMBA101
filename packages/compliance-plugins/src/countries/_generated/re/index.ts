...
export const rUnionScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'RE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Réunion has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const rUnionScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../re/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
