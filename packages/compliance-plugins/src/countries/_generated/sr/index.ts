...
export const surinameScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Suriname has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const surinameScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
