...
export const bouvetIslandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bouvet Island has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bouvetIslandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
