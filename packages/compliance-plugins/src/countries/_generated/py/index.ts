...
export const paraguayScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Paraguay has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const paraguayScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../py/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
