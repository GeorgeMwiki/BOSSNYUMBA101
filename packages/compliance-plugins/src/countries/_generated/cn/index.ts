...
export const chinaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: China has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chinaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
