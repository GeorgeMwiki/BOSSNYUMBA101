...
export const croatiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Croatia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const croatiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
