...
export const libyaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Libya has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const libyaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ly/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
