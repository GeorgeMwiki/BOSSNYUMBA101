...
export const cTeDIvoireScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Côte d\'Ivoire has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cTeDIvoireScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ci/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
