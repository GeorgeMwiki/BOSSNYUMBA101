...
export const bahamasScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bahamas has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bahamasScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bs/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
