...
export const falklandIslandsMalvinasScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'FK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Falkland Islands (Malvinas) has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const falklandIslandsMalvinasScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
