...
export const georgiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Georgia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const georgiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ge/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
