...
export const bulgariaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bulgaria has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bulgariaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
