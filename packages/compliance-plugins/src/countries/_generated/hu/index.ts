...
export const hungaryScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Hungary has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hungaryScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
