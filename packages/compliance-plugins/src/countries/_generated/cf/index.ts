...
export const centralAfricanRepublicScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Central African Republic has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const centralAfricanRepublicScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
