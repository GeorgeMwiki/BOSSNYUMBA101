...
export const ukraineScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'UA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ukraine has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ukraineScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ua/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
