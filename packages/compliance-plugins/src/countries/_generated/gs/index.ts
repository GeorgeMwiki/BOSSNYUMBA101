...
export const southGeorgiaAndTheSouthSandwichIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: South Georgia and the South Sandwich Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const southGeorgiaAndTheSouthSandwichIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gs/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
