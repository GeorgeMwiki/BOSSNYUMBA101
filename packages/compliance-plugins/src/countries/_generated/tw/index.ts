...
export const taiwanProvinceOfChinaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Taiwan, Province of China has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const taiwanProvinceOfChinaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
