...
export const jerseyScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'JE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jersey has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jerseyScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../je/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
