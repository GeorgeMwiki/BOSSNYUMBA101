...
export const guernseyScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guernsey has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guernseyScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
