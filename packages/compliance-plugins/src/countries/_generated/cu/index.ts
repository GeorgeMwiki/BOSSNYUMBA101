...
export const cubaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cuba has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cubaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
