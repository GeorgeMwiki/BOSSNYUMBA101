...
export const gabonScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gabon has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gabonScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ga/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
