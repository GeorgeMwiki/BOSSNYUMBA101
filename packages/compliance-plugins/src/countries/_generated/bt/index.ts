...
export const bhutanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bhutan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bhutanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
