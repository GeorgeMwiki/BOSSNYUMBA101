...
export const ghanaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ghana has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ghanaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gh/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
