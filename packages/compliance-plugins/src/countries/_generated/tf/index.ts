...
export const frenchSouthernTerritoriesScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Southern Territories has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchSouthernTerritoriesScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
