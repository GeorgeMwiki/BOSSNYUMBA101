...
export const saintVincentAndTheGrenadinesScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Vincent and the Grenadines has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintVincentAndTheGrenadinesScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
