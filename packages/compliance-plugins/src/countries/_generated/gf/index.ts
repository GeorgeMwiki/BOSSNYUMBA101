...
export const frenchGuianaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Guiana has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchGuianaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
