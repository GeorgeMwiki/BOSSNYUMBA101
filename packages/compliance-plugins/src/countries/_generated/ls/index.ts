...
export const lesothoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lesotho has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const lesothoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ls/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
