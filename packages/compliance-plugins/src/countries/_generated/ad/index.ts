...
export const andorraScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Andorra has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const andorraScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ad/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
