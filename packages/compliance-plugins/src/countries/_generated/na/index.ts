...
export const namibiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Namibia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const namibiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../na/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
