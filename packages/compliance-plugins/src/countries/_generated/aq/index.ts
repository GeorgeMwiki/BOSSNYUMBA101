...
export const antarcticaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Antarctica has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const antarcticaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../aq/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
