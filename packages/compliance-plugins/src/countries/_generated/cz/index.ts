...
export const czechiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Czechia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const czechiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
