...
export const monacoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Monaco has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const monacoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
