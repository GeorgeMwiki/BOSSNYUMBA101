...
export const saintPierreAndMiquelonScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Pierre and Miquelon has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintPierreAndMiquelonScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
