...
export const tRkiyeScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Türkiye has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tRkiyeScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
