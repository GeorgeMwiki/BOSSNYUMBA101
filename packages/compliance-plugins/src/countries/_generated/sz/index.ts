...
export const eswatiniScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Eswatini has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const eswatiniScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
