...
export const maldivesScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Maldives has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maldivesScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
