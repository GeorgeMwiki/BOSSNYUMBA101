...
export const guadeloupeScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guadeloupe has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guadeloupeScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gp/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
