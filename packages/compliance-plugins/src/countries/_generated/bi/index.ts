...
export const burundiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Burundi has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const burundiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bi/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
