...
export const chadScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Chad has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chadScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../td/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
