...
export const liechtensteinScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Liechtenstein has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const liechtensteinScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../li/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
