...
export const saudiArabiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saudi Arabia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saudiArabiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sa/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
