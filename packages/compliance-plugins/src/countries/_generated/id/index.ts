...
export const indonesiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ID-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Indonesia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const indonesiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../id/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
