...
export const equatorialGuineaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Equatorial Guinea has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const equatorialGuineaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gq/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
