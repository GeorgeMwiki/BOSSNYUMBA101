...
export const somaliaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Somalia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const somaliaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../so/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
