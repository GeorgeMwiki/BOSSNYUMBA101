...
export const luxembourgScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Luxembourg has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const luxembourgScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
