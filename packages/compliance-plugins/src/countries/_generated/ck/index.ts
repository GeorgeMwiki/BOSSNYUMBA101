...
export const cookIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cook Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cookIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ck/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
