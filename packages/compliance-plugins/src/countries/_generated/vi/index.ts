...
export const virginIslandsUSScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Virgin Islands, U.S. has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const virginIslandsUSScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vi/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
