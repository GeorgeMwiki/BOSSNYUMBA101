...
export const caymanIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cayman Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const caymanIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ky/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
