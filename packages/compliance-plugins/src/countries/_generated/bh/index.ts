...
export const bahrainScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bahrain has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bahrainScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bh/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
