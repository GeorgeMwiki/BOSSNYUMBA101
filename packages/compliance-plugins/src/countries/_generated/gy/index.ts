...
export const guyanaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guyana has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guyanaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gy/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
