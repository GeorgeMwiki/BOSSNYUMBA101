...
export const syrianArabRepublicScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Syrian Arab Republic has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const syrianArabRepublicScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sy/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
