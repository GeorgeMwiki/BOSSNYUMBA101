...
export const uzbekistanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'UZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Uzbekistan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const uzbekistanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../uz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
