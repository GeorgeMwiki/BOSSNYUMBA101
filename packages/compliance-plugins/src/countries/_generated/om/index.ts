...
export const omanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'OM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Oman has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const omanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../om/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
