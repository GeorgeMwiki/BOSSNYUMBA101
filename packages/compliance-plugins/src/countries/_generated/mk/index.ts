...
export const northMacedoniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: North Macedonia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const northMacedoniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
