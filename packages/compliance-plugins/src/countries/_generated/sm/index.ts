...
export const sanMarinoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: San Marino has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sanMarinoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
