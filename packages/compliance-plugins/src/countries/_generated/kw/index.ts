...
export const kuwaitScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kuwait has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kuwaitScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
