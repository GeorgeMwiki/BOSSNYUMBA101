...
export const saintLuciaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Lucia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintLuciaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
