...
export const southSudanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: South Sudan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const southSudanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ss/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
