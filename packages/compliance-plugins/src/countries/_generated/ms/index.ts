...
export const montserratScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Montserrat has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const montserratScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ms/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
