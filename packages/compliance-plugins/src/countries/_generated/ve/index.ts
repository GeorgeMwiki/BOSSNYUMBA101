...
export const venezuelaBolivarianRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'VE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Venezuela, Bolivarian Republic of has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const venezuelaBolivarianRepublicOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ve/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
