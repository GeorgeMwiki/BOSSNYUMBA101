...
export const westernSaharaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'EH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Western Sahara has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const westernSaharaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../eh/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
