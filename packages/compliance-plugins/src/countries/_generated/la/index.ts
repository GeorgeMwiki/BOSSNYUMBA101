...
export const laoPeopleSDemocraticRepublicScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lao People\'s Democratic Republic has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const laoPeopleSDemocraticRepublicScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../la/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
