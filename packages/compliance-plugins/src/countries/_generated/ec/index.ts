...
export const ecuadorScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'EC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ecuador has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ecuadorScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ec/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
