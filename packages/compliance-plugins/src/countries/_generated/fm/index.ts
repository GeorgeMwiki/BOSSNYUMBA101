...
export const micronesiaFederatedStatesOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'FM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Micronesia, Federated States of has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const micronesiaFederatedStatesOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
