...
export const latviaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Latvia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const latviaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
