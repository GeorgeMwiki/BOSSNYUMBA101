...
export const wallisAndFutunaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'WF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Wallis and Futuna has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const wallisAndFutunaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../wf/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
