...
export const trinidadAndTobagoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Trinidad and Tobago has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const trinidadAndTobagoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
