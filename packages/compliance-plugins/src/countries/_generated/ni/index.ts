...
export const nicaraguaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nicaragua has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nicaraguaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ni/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
