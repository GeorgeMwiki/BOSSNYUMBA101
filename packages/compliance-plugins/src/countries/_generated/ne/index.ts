...
export const nigerScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Niger has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nigerScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ne/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
