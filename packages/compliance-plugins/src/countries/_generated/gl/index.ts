...
export const greenlandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Greenland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const greenlandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
