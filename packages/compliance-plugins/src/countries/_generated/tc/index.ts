...
export const turksAndCaicosIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Turks and Caicos Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const turksAndCaicosIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
