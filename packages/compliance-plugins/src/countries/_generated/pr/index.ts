...
export const puertoRicoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Puerto Rico has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const puertoRicoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
