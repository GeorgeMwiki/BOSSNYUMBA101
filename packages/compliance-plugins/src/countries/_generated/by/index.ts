...
export const belarusScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belarus has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belarusScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../by/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
