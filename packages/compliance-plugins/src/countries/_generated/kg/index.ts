...
export const kyrgyzstanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kyrgyzstan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kyrgyzstanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
