...
export const bruneiDarussalamScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Brunei Darussalam has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bruneiDarussalamScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
