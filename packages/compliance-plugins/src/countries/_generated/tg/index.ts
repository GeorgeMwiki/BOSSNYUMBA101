...
export const togoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Togo has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const togoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
