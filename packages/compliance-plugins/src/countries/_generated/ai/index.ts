...
export const anguillaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Anguilla has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const anguillaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ai/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
