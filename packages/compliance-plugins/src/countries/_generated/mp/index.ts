...
export const northernMarianaIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Northern Mariana Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const northernMarianaIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mp/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
