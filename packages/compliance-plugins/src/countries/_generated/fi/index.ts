...
export const finlandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'FI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Finland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const finlandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fi/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
