...
export const macaoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Macao has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const macaoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mo/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
