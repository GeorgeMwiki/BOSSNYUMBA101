...
export const azerbaijanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Azerbaijan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const azerbaijanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../az/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
