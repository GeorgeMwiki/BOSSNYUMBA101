...
export const gibraltarScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gibraltar has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gibraltarScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gi/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
