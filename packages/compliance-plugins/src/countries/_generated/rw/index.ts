...
export const rwandaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'RW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Rwanda has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const rwandaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../rw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
