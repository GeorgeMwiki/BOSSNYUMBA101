...
export const lebanonScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lebanon has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const lebanonScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lb/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
