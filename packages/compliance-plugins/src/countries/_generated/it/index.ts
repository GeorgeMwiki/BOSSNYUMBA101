...
export const italyScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Italy has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const italyScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../it/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
