...
export const jordanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'JO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jordan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jordanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../jo/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
