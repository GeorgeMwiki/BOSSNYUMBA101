...
export const landIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Åland Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const landIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ax/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
