...
export const moldovaRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Moldova, Republic of has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const moldovaRepublicOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../md/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
