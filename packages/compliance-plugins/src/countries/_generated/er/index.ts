...
export const eritreaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ER-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Eritrea has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const eritreaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../er/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
