...
export const cocosKeelingIslandsScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cocos (Keeling) Islands has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cocosKeelingIslandsScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
