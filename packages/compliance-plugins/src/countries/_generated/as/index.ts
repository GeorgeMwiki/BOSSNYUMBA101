...
export const americanSamoaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: American Samoa has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const americanSamoaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../as/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
