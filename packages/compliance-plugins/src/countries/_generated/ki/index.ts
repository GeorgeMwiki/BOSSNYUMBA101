...
export const kiribatiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kiribati has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kiribatiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ki/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
