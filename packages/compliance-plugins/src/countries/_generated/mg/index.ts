...
export const madagascarScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Madagascar has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const madagascarScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
