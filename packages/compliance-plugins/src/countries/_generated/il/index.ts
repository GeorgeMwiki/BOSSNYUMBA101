...
export const israelScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Israel has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const israelScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../il/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
