...
export const beninScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Benin has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const beninScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bj/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
