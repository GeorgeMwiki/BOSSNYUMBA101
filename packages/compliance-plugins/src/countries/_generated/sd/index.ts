...
export const sudanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sudan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sudanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sd/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
