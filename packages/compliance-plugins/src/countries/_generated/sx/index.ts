...
export const sintMaartenDutchPartScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sint Maarten (Dutch part) has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sintMaartenDutchPartScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sx/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
