...
export const portugalScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Portugal has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const portugalScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
