...
export const spainScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ES-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Spain has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const spainScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../es/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
