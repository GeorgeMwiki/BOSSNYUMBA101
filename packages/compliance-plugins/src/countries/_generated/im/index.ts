...
export const isleOfManScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Isle of Man has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const isleOfManScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../im/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
