...
export const tuvaluScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tuvalu has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tuvaluScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
