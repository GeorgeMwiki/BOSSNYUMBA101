...
export const newZealandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: New Zealand has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const newZealandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
