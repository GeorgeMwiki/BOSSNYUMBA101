...
export const tokelauScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tokelau has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tokelauScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
