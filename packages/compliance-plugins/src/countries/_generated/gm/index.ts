...
export const gambiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gambia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gambiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
