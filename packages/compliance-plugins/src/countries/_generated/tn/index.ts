...
export const tunisiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tunisia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tunisiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
