...
export const antiguaAndBarbudaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Antigua and Barbuda has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const antiguaAndBarbudaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ag/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
