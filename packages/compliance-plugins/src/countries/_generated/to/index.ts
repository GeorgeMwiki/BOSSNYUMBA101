...
export const tongaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tonga has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tongaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../to/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
