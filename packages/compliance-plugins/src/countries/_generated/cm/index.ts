...
export const cameroonScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cameroon has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cameroonScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
