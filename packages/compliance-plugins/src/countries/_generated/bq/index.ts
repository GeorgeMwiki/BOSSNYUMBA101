...
export const bonaireSintEustatiusAndSabaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bonaire, Sint Eustatius and Saba has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bonaireSintEustatiusAndSabaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bq/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
