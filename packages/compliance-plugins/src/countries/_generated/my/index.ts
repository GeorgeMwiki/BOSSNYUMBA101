...
export const malaysiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malaysia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const malaysiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../my/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
