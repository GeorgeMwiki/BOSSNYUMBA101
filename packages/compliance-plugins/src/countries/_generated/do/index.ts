...
export const dominicanRepublicScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'DO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Dominican Republic has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const dominicanRepublicScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../do/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
