...
export const swedenScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sweden has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const swedenScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../se/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
