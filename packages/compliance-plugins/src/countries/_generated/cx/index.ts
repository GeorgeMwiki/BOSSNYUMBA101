...
export const christmasIslandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Christmas Island has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const christmasIslandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cx/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
