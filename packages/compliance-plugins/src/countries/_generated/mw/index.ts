...
export const malawiScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malawi has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const malawiScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
