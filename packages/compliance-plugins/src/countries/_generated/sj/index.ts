...
export const svalbardAndJanMayenScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Svalbard and Jan Mayen has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const svalbardAndJanMayenScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sj/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
