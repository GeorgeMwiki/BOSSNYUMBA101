...
export const bangladeshScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bangladesh has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bangladeshScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bd/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
