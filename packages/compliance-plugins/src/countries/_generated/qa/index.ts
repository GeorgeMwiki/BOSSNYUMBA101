...
export const qatarScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'QA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Qatar has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const qatarScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../qa/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
