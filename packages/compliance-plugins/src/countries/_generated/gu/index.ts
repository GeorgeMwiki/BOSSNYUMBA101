...
export const guamScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guam has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guamScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
