...
export const bosniaAndHerzegovinaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bosnia and Herzegovina has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bosniaAndHerzegovinaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ba/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
