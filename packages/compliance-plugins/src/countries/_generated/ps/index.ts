...
export const palestineStateOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Palestine, State of has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const palestineStateOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ps/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
