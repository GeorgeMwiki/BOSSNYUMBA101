...
export const guineaBissauScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guinea-Bissau has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guineaBissauScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
