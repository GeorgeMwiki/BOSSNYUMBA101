...
export const switzerlandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Switzerland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const switzerlandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ch/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
