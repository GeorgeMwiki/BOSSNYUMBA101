...
export const saoTomeAndPrincipeScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ST-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sao Tome and Principe has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saoTomeAndPrincipeScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../st/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
