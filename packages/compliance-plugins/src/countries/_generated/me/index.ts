...
export const montenegroScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'ME-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Montenegro has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const montenegroScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../me/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
