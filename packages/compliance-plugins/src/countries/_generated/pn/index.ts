...
export const pitcairnScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Pitcairn has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const pitcairnScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
