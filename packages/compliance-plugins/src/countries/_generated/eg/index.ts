...
export const egyptScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'EG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Egypt has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const egyptScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../eg/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
