...
export const pakistanScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Pakistan has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const pakistanScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
