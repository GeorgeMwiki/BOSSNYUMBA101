...
export const newCaledoniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: New Caledonia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const newCaledoniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nc/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
