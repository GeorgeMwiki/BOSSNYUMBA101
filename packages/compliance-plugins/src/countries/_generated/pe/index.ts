...
export const peruScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Peru has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const peruScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pe/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
