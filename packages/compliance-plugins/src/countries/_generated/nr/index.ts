...
export const nauruScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'NR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nauru has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nauruScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
