...
export const albaniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'AL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Albania has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const albaniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../al/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
