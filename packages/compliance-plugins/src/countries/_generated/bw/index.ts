...
export const botswanaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'BW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Botswana has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const botswanaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
