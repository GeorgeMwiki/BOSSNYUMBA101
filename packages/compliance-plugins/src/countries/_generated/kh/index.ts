...
export const cambodiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cambodia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cambodiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kh/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
