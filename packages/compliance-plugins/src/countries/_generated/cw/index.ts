...
export const curaAoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Curaçao has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const curaAoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
