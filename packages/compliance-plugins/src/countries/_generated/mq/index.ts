...
export const martiniqueScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Martinique has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const martiniqueScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mq/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
