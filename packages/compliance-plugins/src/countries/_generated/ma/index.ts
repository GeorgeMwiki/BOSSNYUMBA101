...
export const moroccoScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Morocco has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const moroccoScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ma/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
