...
export const koreaDemocraticPeopleSRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'KP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Korea, Democratic People\'s Republic of has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const koreaDemocraticPeopleSRepublicOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kp/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
