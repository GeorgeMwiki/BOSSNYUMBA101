...
export const colombiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Colombia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const colombiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../co/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
