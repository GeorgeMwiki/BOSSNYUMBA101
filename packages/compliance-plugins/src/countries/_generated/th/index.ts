...
export const thailandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'TH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Thailand has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const thailandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../th/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
