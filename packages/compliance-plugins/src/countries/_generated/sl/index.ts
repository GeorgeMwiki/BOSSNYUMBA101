...
export const sierraLeoneScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sierra Leone has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sierraLeoneScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sl/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
