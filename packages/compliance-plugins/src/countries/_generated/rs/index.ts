...
export const serbiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'RS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Serbia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const serbiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../rs/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
