...
export const hongKongScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'HK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Hong Kong has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hongKongScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
