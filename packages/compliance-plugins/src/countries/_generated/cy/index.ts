...
export const cyprusScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cyprus has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cyprusScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cy/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
