...
export const estoniaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'EE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Estonia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const estoniaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ee/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
