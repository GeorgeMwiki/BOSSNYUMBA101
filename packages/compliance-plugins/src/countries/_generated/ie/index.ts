...
export const irelandScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ireland has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const irelandScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ie/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
