...
export const jamaicaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'JM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jamaica has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jamaicaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../jm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
