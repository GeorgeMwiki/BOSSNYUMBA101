...
export const mongoliaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mongolia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mongoliaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
