...
export const iraqScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Iraq has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const iraqScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../iq/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
