...
export const liberiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'LR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Liberia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const liberiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
