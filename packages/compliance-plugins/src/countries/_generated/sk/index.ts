...
export const slovakiaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Slovakia has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const slovakiaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sk/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
