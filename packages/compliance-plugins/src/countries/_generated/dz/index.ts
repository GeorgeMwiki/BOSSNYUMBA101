...
export const algeriaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'DZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Algeria has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const algeriaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dz/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
