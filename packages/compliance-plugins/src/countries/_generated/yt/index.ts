...
export const mayotteScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'YT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mayotte has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mayotteScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../yt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
