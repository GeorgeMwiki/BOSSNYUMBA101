...
export const myanmarScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Myanmar has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const myanmarScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mm/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
