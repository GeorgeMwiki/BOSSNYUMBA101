...
export const mauritiusScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mauritius has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mauritiusScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mu/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
