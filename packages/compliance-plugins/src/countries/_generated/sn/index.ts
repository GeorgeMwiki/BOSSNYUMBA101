...
export const senegalScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Senegal has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const senegalScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sn/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
