...
export const costaRicaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Costa Rica has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const costaRicaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cr/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
