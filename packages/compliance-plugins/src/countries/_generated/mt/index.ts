...
export const maltaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'MT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malta has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maltaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mt/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
