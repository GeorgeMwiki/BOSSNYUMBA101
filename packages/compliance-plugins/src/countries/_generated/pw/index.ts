...
export const palauScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'PW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Palau has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const palauScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pw/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
