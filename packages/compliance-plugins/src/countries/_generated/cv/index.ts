...
export const caboVerdeScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'CV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cabo Verde has no programmed withholding rate. Consult local tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const caboVerdeScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cv/index.ts and implement real tax rates + lease-law from local sources. See _generated/README.md.',
});
