// @ts-nocheck FIXME(am3): domain-models has PaymentMethod/WorkOrder exported as namespaces not types + missing PaymentIntentStatus / PaymentType / PaymentMethodId type exports. Rewrite pending domain-models namespace→type refactor. Tracked: BOSSNYUMBA-42.
/**
