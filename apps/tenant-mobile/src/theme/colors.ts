...
//
// Direction: "Midnight Slate Ledger with Warm Signal Accent" — matches
// the marketing site, owner-web, and admin-web. Dark-navy slate
// foundation (#0B0F19), a warm accent as the only signal, cream
// off-white type, emerald success, warm-red danger. Earth tones
// retained as soft accents so provenance / verification cards still
// feel grounded.
//
// Field-tested for outdoor readability on cheap Android devices — the
// accent/cream contrast on the slate background lands at WCAG AA in
...
export const colors = {
  ...
  // Signal — warm accent (one brand color)
  accent: '#FFC857',          // hero accent (#FFC857)
  accentSoft: '#F5B23E',      // hover / pressed
  accentDeep: '#FFD888',      // softer accent for runs
  ...
  successSoft: '#1B3D2E',
  warning: '#FFC857',         // accent doubles as warning
  warningSoft: '#3A2F18',
