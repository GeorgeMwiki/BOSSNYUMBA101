...
export interface BnBottomSheetProps {
...
export function BnBottomSheet({
  ...
  children,
  testID
}: BnBottomSheetProps): JSX.Element {
  return (
    <Modal
      visible={visible}
      transparent
