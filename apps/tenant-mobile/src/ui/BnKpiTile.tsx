...
export type BnKpiTone = 'gold' | 'success' | 'warn' | 'danger' | 'neutral'

export interface BnKpiTileProps {
  readonly eyebrow: string
  readonly value: string
  readonly delta?: string
  readonly tone?: BnKpiTone
...
function toneAccent(tone: BnKpiTone): string {
