...
export interface BnAvatarProps {
...
/**
 * Circular avatar with gold ring (BossNyumba's signature for active users
 * and personas). Renders initials in cream-on-deep-navy with an optional
 * 2px gold halo.
 */
export function BnAvatar({ name, size = 40, ringed = true }: BnAvatarProps): JSX.Element {
