...
export interface BnErrorStateProps {
...
/**
 * BossNyumba error / 404 / offline state — centred cluster with plate
 * icon, title, body, and CTA pair. Tone tints the plate accent.
 */
export function BnErrorState({
  icon = '!',
  title,
  description,
  primaryCta,
