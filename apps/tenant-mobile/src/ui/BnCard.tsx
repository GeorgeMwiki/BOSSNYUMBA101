...
export type BnCardTone = 'raised' | 'deep' | 'gold' | 'success' | 'danger'

export interface BnCardProps {
  readonly children: ReactNode
  readonly tone?: BnCardTone
...
/**
 * BossNyumba signature card — `rounded-3xl border border-white/10 bg-navy/60
 * backdrop-blur-xl shadow-card`, translated for React Native. Tones add a
 * subtle 2px top accent matching the BossNyumba variant family.
 */
export function BnCard({
  children,
  tone = 'raised',
  onPress,
  style,
