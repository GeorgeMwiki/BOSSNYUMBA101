...
export const metadata: Metadata = {
  ...
  description:
    'Mr. Mwikila collects rent over M-Pesa, chases late tenants in Swahili, files the council levy, and emails you a one-page owner statement. Free on Mkulima (T1) for up to 5 units.',
};
