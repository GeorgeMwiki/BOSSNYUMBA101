...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (locale === 'sw') {
    return {
      title: 'Blogu — BossNyumba',
      description:
        'Maelezo kutoka uwanjani katika sekta ya mali ya Afrika Mashariki. Uzinduzi wa bidhaa, uunganishaji wa M-Pesa, mabadiliko ya kanuni, na mafunzo kutoka kwa makundi halisi ya mali.',
    };
  }
  return {
  ...
  return (
    <PageShell>
      <div className="mx-auto max-w-3xl px-6 pb-24 pt-20 lg:px-8">
        <p className="font-mono text-xs uppercase tracking-widest text-signal-500">Blog</p>
        <h1 className="mt-4 font-display text-4xl font-medium tracking-tight text-balance sm:text-5xl">
          Field notes from the property frontier.
        </h1>
        <p className="mt-6 text-lg leading-relaxed text-foreground/75">
          Product launches, M-Pesa integrations, regulatory changes, and lessons from real
          portfolios in Tanzania and Kenya.
        </p>
