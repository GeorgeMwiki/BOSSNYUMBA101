  ...
  return (
    <PageShell>
      <article className="mx-auto max-w-3xl px-6 pb-24 pt-20 prose prose-invert prose-neutral lg:px-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          We process portfolio, tenant, and payment data for as long as
          your account is active and for the retention windows in the
          Privacy Notice.
        </p>
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          See the <a href="/security" className="text-signal-500 hover:underline">Security Policy</a>.
          Encryption at rest (AES-256) and in transit (TLS 1.3). Row-level
          security on every tenant-scoped table. Cryptographic audit chain.
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          You consent to the current sub-processors. We give 30 days&apos;
          notice before adding new sub-processors. You may object; if we
          cannot accommodate, you may terminate without penalty.
        </p>
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          Primary processing is in EAT region. For transfers to the EU
          and US, we rely on Standard Contractual Clauses and (where
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          We notify you of a confirmed personal data breach within 24
          hours and provide reasonable cooperation for your own
        ...
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">
          On termination, you may export your data for 90 days. After
          that we delete it, except hash-chained audit logs required to
          satisfy tax and regulatory retention.
        </p>
      </article>
    </PageShell>
  );
