...
export const COMPARISON: readonly ComparisonFeature[] = [
  ...
  { group: 'Finance',      groupSw: 'Fedha',           feature: 'Scheduled owner disbursements',                          featureSw: 'Malipo ya mwenye nyumba yaliyopangwa',                                tiers: ['mwanafamilia', 'mfanyabiashara', 'kampuni', 'group'] },
  // === Compliance ===
  ...
  { group: 'Compliance',   groupSw: 'Utii',            feature: 'Regulator filing — four-eye approved, audit-chained',     featureSw: 'Uwasilishaji kwa mdhibiti — idhini ya macho-manne, mnyororo wa ukaguzi', tiers: ['kampuni', 'group'] },
  { group: 'Compliance',   groupSw: 'Utii',            feature: 'Council levy + property-tax filing (you approve)',        featureSw: 'Uwasilishaji wa ushuru wa halmashauri na kodi ya mali (unaidhinisha)', tiers: ['mfanyabiashara', 'kampuni', 'group'] },
  // === People ===
  ...
  { group: 'Trust',        groupSw: 'Uaminifu',        feature: 'Uptime SLA + named support engineer',                    featureSw: 'SLA ya muda wa kufanya kazi + mhandisi wa msaada aliyetajwa',          tiers: ['group'] },
