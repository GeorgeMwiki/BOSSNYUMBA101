...
const mockCases: SupportCaseRecord[] = [
  { id: '1', ticketNumber: 'SUP-2026-0142', subject: 'Unable to process M-Pesa payments', description: 'Payment gateway timing out', status: 'escalated', priority: 'critical', category: 'Payments', tenant: 'Acme Properties Ltd', requester: { name: 'John Kamau', email: 'john@acme.co.ke', phone: '+254700000000' }, assignee: 'Level 2 Support', escalationLevel: 2, createdAt: '2026-02-13T08:00:00Z', updatedAt: '2026-02-13T10:00:00Z' },
