...
function useFallbackChecklist(): ChecklistResponse {
  ...
  return useMemo(
    () => ({
      tenantId: 'pending',
      businessName: t('businessNameFallback'),
      ...
      steps: [
        ...
        },
        {
          ...
          description: t('importTenantsDesc'),
          completed: false,
        },
        {
          id: 'first_md_chat',
          label: t('chatFirstTime'),
          description: t('chatFirstTimeDesc'),
          completed: false,
        },
        {
          id: 'owner_intent',
          label: t('pickOwnerIntent'),
          description: t('pickOwnerIntentDesc'),
          completed: false,
        },
        {
          id: 'install_starter_skills',
          label: t('installStarterSkills'),
          description: t('installStarterSkillsDesc'),
          completed: false,
        },
        {
          id: 'schedule_daily_briefing',
          label: t('scheduleBriefing'),
          description: t('scheduleBriefingDesc'),
          completed: false,
        },
      ],
      intent: null,
