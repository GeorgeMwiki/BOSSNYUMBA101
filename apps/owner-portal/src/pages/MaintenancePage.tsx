    ...
    return (
      <div className="animate-pulse space-y-6">
        ...
        <div className="flex items-center gap-4">
          {[1,2,3,4,5].map(i => <div key={i} className="h-8 bg-gray-200 rounded-lg w-24" />)}
        </div>
        {[1,2,3,4].map(i => (
          <div key={i} className="rounded-xl border border-gray-200 bg-white p-4">
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-96 gap-4">
        ...
        <h2 className="text-lg font-semibold text-gray-900">Maintenance Unavailable</h2>
    ...
    <div className="space-y-6">
      ...
      {filteredOrders.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-xl border border-gray-200">
          ...
          <h3 className="text-base font-semibold text-gray-900 mb-1">No Work Orders Found</h3>
          <p className="text-sm text-gray-500 max-w-sm">
            {filter !== 'all' || categoryFilter !== 'all'
              ? 'Try adjusting your filters to see more work orders.'
