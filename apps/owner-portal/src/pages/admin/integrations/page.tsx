    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-200">
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900">Failed to Load Integrations</h2>
      ...
      {integrations.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1 max-w-md">
            Third-party integrations will appear here once configured by the platform.
          </p>
        </div>
      )}
    </div>
