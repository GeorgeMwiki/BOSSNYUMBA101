...
const ENTRIES: ReadonlyArray<CapabilityEntry> = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    public_description: {
      en: 'Ask Mr. Mwikila to draft a lease, tenancy agreement, or service contract. Review fields, edit inline, lock and send when ready.',
      sw: 'Mwombe Mwikila aandae mkataba wa kupanga, makubaliano ya upangaji, au mkataba wa huduma. Hakiki nyanja, hariri papo hapo, funga na tuma ukimaliza.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Yes. Tell me the kind of contract and the key terms. For example, "draft a tenancy agreement for ABC Tenants, Unit 4B at Oyster Bay, TZS 1.2M/month, 12-month term starting in 30 days." I will produce the draft, you review the fields, then we lock and send.',
      sw: 'Ndio. Niambie aina ya mkataba na masharti makuu. Kwa mfano, "andaa mkataba wa upangaji kwa ABC Tenants, Kitengo 4B Oyster Bay, TZS 1.2M kwa mwezi, muda wa miezi 12 kuanzia siku 30." Nitaandaa rasimu, wewe hakiki nyanja, kisha tunafunga na kutuma.',
    },
  ...
  },
  {
    ...
    example_question: {
      en: 'Write me an LOI for the prospective tenant',
      sw: 'Niandalie LOI kwa mpangaji mtarajiwa',
    },
    example_response_pattern: {
      en: 'Happy to. Tenant name, unit, rent, and move-in date — give me those four and I will produce a draft you can review.',
      sw: 'Sawa kabisa. Jina la mpangaji, kitengo, kodi, na tarehe ya kuhamia — nipe hayo manne na nitaandaa rasimu utakayoweza kuhakiki.',
    },
  ...
  },
  {
    ...
    example_question: {
      en: 'I need an RFP for cleaning services across the estate',
      sw: 'Nahitaji RFP kwa huduma za usafi katika mali zote',
    },
    example_response_pattern: {
      en: 'Got it. Scope, properties covered, frequency, and your evaluation criteria (price-only, or weighted with quality / capacity / reliability)? I will produce the RFP and an invite list.',
      sw: 'Vizuri. Mawanda, mali zinazohusika, mara ngapi, na vigezo vyako vya tathmini (bei pekee, au mchanganyiko wa ubora / uwezo / uaminifu)? Nitaandaa RFP na orodha ya kualika.',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'Mr. Mwikila compiles a board-ready or regulator-ready report from your operating data — occupancy, rent collection, arrears, workforce, safety, treasury.',
      sw: 'Mwikila hukusanya ripoti kamili kutoka takwimu zako za uendeshaji — upangishaji, ukusanyaji wa kodi, malimbikizo, wafanyakazi, usalama, fedha.',
    },
    example_question: {
  ...
  },
  {
    ...
    public_description: {
      en: 'Letters to the housing regulator, the local council, TRA, banks, tenants, community leaders — Mr. Mwikila produces the draft in the right register and language.',
      sw: 'Barua kwa mamlaka ya makazi, halmashauri, TRA, benki, wapangaji, viongozi wa jamii — Mwikila huandaa rasimu kwa lugha na muundo unaohitajika.',
    },
    example_question: {
      en: 'Write a letter to TRA asking for a rental-tax filing extension',
      sw: 'Andika barua kwa TRA kuomba muda zaidi wa kuwasilisha kodi ya pango',
    },
    example_response_pattern: {
  ...
  },
  {
    ...
    public_description: {
      ...
      sw: 'Mwikila huunda kiungo salama cha rasimu ili mpangaji au muuzaji aweze kuhakiki bila kuhitaji akaunti ya BossNyumba. Kiungo huishia chenyewe.',
    },
    example_question: {
  ...
  },
  {
    ...
    topic: 'drafting',
    user_outcome: 'Owner produces a winning tender response without copy-paste.',
    public_name: {
      en: 'Respond to an open tender',
      sw: 'Jibu zabuni iliyopo',
    },
    public_description: {
      en: 'Mr. Mwikila drafts your response to an open service tender or request, pre-filled with your registration, capacity, and price floor.',
      sw: 'Mwikila huandaa jibu lako kwa zabuni au ombi la huduma lililopo, ikiwa imejazwa usajili, uwezo, na bei ya chini.',
    },
    example_question: {
      en: 'Help me bid on the estate security tender',
      sw: 'Nisaidie kuomba zabuni ya ulinzi wa mali',
    },
    example_response_pattern: {
      en: 'I have your last three service rates on file. I will use those plus the tender\'s scope. Anything special you want me to lead with — capacity, track record, or local hire?',
      sw: 'Nina viwango vyako vitatu vya mwisho vya huduma kwenye faili. Nitatumia hivyo pamoja na mawanda ya zabuni. Kuna kitu maalum unataka nikiweke mbele — uwezo, rekodi, au ajira ya ndani?',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'Common documents — service contracts, tenancy agreements, NDAs, employment letters — are available as templates Mr. Mwikila tailors to your estate.',
      sw: 'Hati za kawaida — mikataba ya huduma, upangaji, NDA, ajira — zinapatikana kama violezo Mwikila ataviwekea estate yako.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'I can start an NDA, employment letter, tenancy agreement, maintenance contract, security service contract, or community engagement MoU. Which fits today?',
      sw: 'Naweza kuanza NDA, barua ya ajira, mkataba wa upangaji, mkataba wa matengenezo, mkataba wa ulinzi, au MoU ya jamii. Ipi inafaa leo?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    id: 'mwikila.track.lettings',
    topic: 'tracking',
    user_outcome: 'Owner sees every new lease by unit, tenant, and date.',
    public_name: {
      en: 'Track new lettings in real time',
      sw: 'Fuatilia upangishaji mpya kwa wakati halisi',
    },
    public_description: {
      en: 'Every letting recorded — unit, tenant, term, rent, deposit, payment status — kept on the cockpit and searchable months later.',
      sw: 'Kila upangishaji umerekodiwa — kitengo, mpangaji, muda, kodi, amana, hali ya malipo — huhifadhiwa kwenye dashibodi na kutafutwa miezi baadaye.',
    },
    example_question: {
      en: 'What did we let last week?',
      sw: 'Tulipangisha nini wiki iliyopita?',
    },
    example_response_pattern: {
      en: 'Three units last week — Unit 4B at Oyster Bay to ABC at TZS 1.2M/month, a shop at Masaki to XYZ, a warehouse to a local trader. Want the tenant breakdown or the cash settlement view?',
      sw: 'Vitengo vitatu wiki iliyopita — Kitengo 4B Oyster Bay kwa ABC kwa TZS 1.2M kwa mwezi, duka Masaki kwa XYZ, ghala kwa mfanyabiashara wa ndani. Unataka mchanganuo wa wapangaji au mwonekano wa malipo?',
    },
  ...
  },
  {
    ...
    public_name: {
      en: 'Track rent owed and collected',
      sw: 'Fuatilia kodi inayodaiwa na iliyokusanywa',
    },
    public_description: {
      en: 'Mr. Mwikila keeps a running total of rent owed by unit and by month, plus the collection status against each due date.',
      sw: 'Mwikila huhifadhi jumla ya kodi inayodaiwa kwa kitengo na kwa mwezi, pamoja na hali ya ukusanyaji kabla ya kila tarehe ya mwisho.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'April rent is sitting at TZS 18.4M across your occupied units. The statement is ready; the next due date is in 4 days. Want me to walk you through it before you send reminders?',
      sw: 'Kodi ya Aprili ni TZS 18.4M kutoka vitengo vyako vilivyopangishwa. Taarifa ipo tayari; tarehe ya mwisho inayofuata ni siku 4. Unataka nikupitishe kabla ya kutuma kumbukumbu?',
    },
    related: ['mwikila.track.lettings', 'mwikila.alert.payment'],
    visibility: 'PUBLIC',
  },
  {
    ...
    public_name: {
      ...
      sw: 'Fuatilia kalenda ya mikataba',
    },
    public_description: {
      en: 'Fixed-term and periodic tenancies — Mr. Mwikila tracks every active lease, the days remaining, and pre-fills the renewal notice 47 days before expiry.',
      sw: 'Mikataba ya muda maalum na ya kawaida — Mwikila hufuatilia kila mkataba, siku zilizobaki, na kujaza notisi ya upyaji siku 47 kabla ya muda kuisha.',
    },
    example_question: {
      en: 'Any leases expiring soon?',
      sw: 'Kuna mikataba inayoisha hivi karibuni?',
    },
    example_response_pattern: {
      en: 'Two leases hit the 90-day window. Oyster Bay Unit 2 has 23 days and is auto-queued; Masaki Court needs your sign-off in the next 47. Tap to open either.',
      sw: 'Mikataba miwili inakaribia siku 90. Oyster Bay Kitengo 2 kina siku 23 kimesajiliwa moja kwa moja; Masaki Court inahitaji saini yako ndani ya siku 47. Bonyeza kufungua mojawapo.',
    },
    related: ['mwikila.alert.lease', 'mwikila.compliance.anti-graft'],
    visibility: 'PUBLIC',
  },
  {
    ...
    public_description: {
      en: 'Every property shows occupancy, workforce on shift, open cases, and the latest regulator state in one view.',
      sw: 'Kila mali huonesha upangishaji, wafanyakazi kazini, kesi zilizofunguliwa, na hali ya mwisho ya wadhibiti katika mwonekano mmoja.',
    },
    example_question: {
      en: 'How is Oyster Bay doing today?',
      sw: 'Oyster Bay inafanyaje leo?',
    },
    example_response_pattern: {
      en: 'Oyster Bay: 94% occupied today, 38 staff on shift, zero open cases. The council inspection is 12 days out. Want me to open the full Oyster Bay view?',
      sw: 'Oyster Bay: imepangishwa 94% leo, wafanyakazi 38 kazini, hakuna kesi. Ukaguzi wa halmashauri ni siku 12. Unataka nifungue mwonekano kamili wa Oyster Bay?',
    },
  ...
  },
  {
    ...
    example_response_pattern: {
      en: '38 staff on shift across all properties — 24 at Oyster Bay, 9 at Masaki Court, 5 at Mikocheni East. Three have certifications expiring this month. Want the list?',
      sw: 'Wafanyakazi 38 kazini katika mali zote — 24 Oyster Bay, 9 Masaki Court, 5 Mikocheni East. Watatu wana vyeti vinavyoisha mwezi huu. Unataka orodha?',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'M-Pesa, bank transfers, USD wires — Mr. Mwikila reconciles each entry to a lease, a supplier, or payroll, so your books stay current.',
      sw: 'M-Pesa, uhamisho wa benki, wire za USD — Mwikila huoanisha kila kiingilio na mkataba, muuzaji, au malipo, ili vitabu vyako vikae sasa.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'ABC paid TZS 1.2M against lease #L-0418 at 09:14 today. The reconciliation is clean — net of bank fees TZS 1.18M. Anything else you want to check on that lease?',
      sw: 'ABC walilipa TZS 1.2M kwa mkataba #L-0418 saa 09:14 leo. Uoanishaji ni safi — baada ya ada za benki TZS 1.18M. Kuna kingine cha kuhakiki kwenye mkataba huo?',
    },
    related: ['mwikila.track.lettings', 'mwikila.forecast.cashflow'],
    visibility: 'PUBLIC',
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    public_name: {
      ...
      sw: 'Onyo la mapema la kuisha kwa mkataba',
    },
    public_description: {
      en: 'Mr. Mwikila warns you 90, 60, 47, 30, and 7 days before any lease expires, with the renewal notice already pre-filled.',
      sw: 'Mwikila hukuonya siku 90, 60, 47, 30, na 7 kabla ya mkataba wowote kuisha, notisi ya upyaji ikiwa tayari imejazwa.',
    },
    example_question: {
      en: 'Will you remind me before leases expire?',
      sw: 'Utanikumbusha kabla mikataba haijaisha?',
    },
    example_response_pattern: {
  ...
  },
  {
    ...
    public_description: {
      en: 'Tenants who miss their rent window, suppliers you forgot to pay, or M-Pesa receipts that did not reconcile — Mr. Mwikila flags each one.',
      sw: 'Wapangaji waliokosa muda wa kodi, wauzaji ulisahau kuwalipa, au risiti za M-Pesa zisizoendana — Mwikila huzionesha zote.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Two. XYZ Tenant is 4 days late on TZS 1.2M for lease #L-0411. The maintenance vendor invoice from 12 days ago is unpaid — TZS 6.3M. Want to chase one of them now?',
      sw: 'Mawili. XYZ amechelewa siku 4 kwa TZS 1.2M ya mkataba #L-0411. Ankara ya matengenezo ya siku 12 zilizopita haijalipwa — TZS 6.3M. Unataka kufuatilia mojawapo sasa?',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'Electrical, HVAC, first-aid — Mr. Mwikila tracks every cert and warns 60 / 30 / 7 days before lapse so you stay compliant.',
      sw: 'Umeme, HVAC, msaada wa kwanza — Mwikila hufuatilia kila cheti na huonya siku 60 / 30 / 7 kabla ya kuisha ili ubaki na utii.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Three this month. Juma\'s electrical cert expires May 18, two HVAC technician licences expire May 24. I have the refresh courses scheduled — want me to confirm the bookings?',
      sw: 'Vitatu mwezi huu. Cheti cha umeme cha Juma kinaisha Mei 18, leseni mbili za fundi wa HVAC zinaisha Mei 24. Nimepanga kozi za upyaji — unataka nithibitishe?',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'Unusual occupancy drops, FX exposure spikes, weather risks to building works, audit flags — Mr. Mwikila surfaces them while you can still act.',
      sw: 'Kushuka kwa upangishaji, ongezeko la hatari ya fedha za kigeni, hali ya hewa dhidi ya kazi za ujenzi, alama za ukaguzi — Mwikila huzionesha wakati bado unaweza kufanya kitu.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Two flags worth looking at. Masaki Court occupancy is 14% below the rolling average for 5 days running, and the USD window swings the next 48 hours could cost you TZS 11M on the unhedged USD-denominated lease. Want to dig into either?',
      sw: 'Alama mbili za kuangalia. Upangishaji wa Masaki Court uko chini ya wastani kwa 14% siku 5 mfululizo, na mtikisiko wa USD masaa 48 yajayo unaweza kukugharimu TZS 11M kwenye mkataba wa USD usiofungwa. Unataka kuchunguza mojawapo?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    public_description: {
      en: 'Mr. Mwikila projects cash in (rent, payments due) and cash out (loan repayments, payroll, vendor) so you know where you will stand at month-end.',
      sw: 'Mwikila hutabiri fedha zinazoingia (kodi, malipo) na zinazotoka (marejesho ya mikopo, mishahara, wauzaji) ili ujue utakapokuwa mwisho wa mwezi.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'On current pace, yes. June payroll is TZS 84M; the projected June 25 balance after loan repayments is TZS 112M. The risk is if XYZ slips again — that pulls TZS 42M out of the buffer.',
      sw: 'Kwa mwendo wa sasa, ndio. Mshahara wa Juni ni TZS 84M; baki itakayobaki Juni 25 baada ya marejesho ya mikopo ni TZS 112M. Hatari ni kama XYZ atachelewa tena — hiyo huondoa TZS 42M kwenye akiba.',
    },
  ...
  },
  {
    ...
    public_name: {
      ...
      sw: 'Tabiri kodi ya mwezi unaofuata',
    },
    public_description: {
      en: 'Based on occupancy, lease mix, and renewal trend, Mr. Mwikila projects the rent you will collect next month.',
      sw: 'Kutoka upangishaji, mchanganyiko wa mikataba, na mwenendo wa upyaji, Mwikila hutabiri kodi utakayokusanya mwezi unaofuata.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Tracking around TZS 21M, give or take 8% depending on the two renewals closing this Friday. I can hold the projection and update you on Friday close.',
      sw: 'Inakaribia TZS 21M, jia au chini ya 8% kulingana na upyaji wawili wanaokamilika Ijumaa hii. Naweza kushikilia utabiri na kukujulisha Ijumaa.',
    },
  ...
  },
  {
    ...
    example_response_pattern: {
      en: 'You are running about TZS 82-86M monthly. Overtime at Masaki Court has crept up TZS 4M over March — want me to break that out?',
      sw: 'Unaendesha kati ya TZS 82-86M kwa mwezi. Muda wa ziada Masaki Court umeongezeka TZS 4M tangu Machi — unataka nikuchanganue?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    example_question: {
      en: 'Ask the Oyster Bay manager why occupancy dropped',
      sw: 'Mwulize msimamizi wa Oyster Bay kwanini upangishaji ulishuka',
    },
    example_response_pattern: {
      en: 'Sent. Asked Daudi to confirm the open-unit status and the generator uptime. I will alert you the moment he replies — usually within 30 minutes during shift.',
      sw: 'Imetumwa. Nimemwomba Daudi athibitishe hali ya vitengo vilivyo wazi na jenereta. Nitakujulisha mara atakapojibu — kwa kawaida ndani ya dakika 30 wakati wa zamu.',
    },
  ...
  },
  {
    ...
    public_description: {
      en: 'Chase a rent payment, update a move-in date, share a lease document — all from chat, tracked in the tenant relationship history.',
      sw: 'Fuatilia malipo ya kodi, sasisha tarehe ya kuhamia, shiriki hati ya mkataba — yote kutoka kwenye gumzo, vinafuatiliwa kwenye historia ya uhusiano.',
    },
    example_question: {
  ...
  },
  {
    ...
    public_description: {
      en: 'The housing regulator, the local council, TRA, BoT, BRELA — Mr. Mwikila composes the request, attaches the right evidence, and tracks the response window.',
      sw: 'Mamlaka ya makazi, halmashauri, TRA, BoT, BRELA — Mwikila huandika ombi, kuambatisha ushahidi, na kufuatilia muda wa jibu.',
    },
    example_question: {
      en: 'I need to ask the council for a property inspection',
      sw: 'Nahitaji kuomba halmashauri ukaguzi wa mali',
    },
    example_response_pattern: {
      en: 'Will do. Which property, what date range, and is there a specific concern (compliance check, occupancy certificate, complaint follow-up)? I will draft and queue for your sign-off.',
      sw: 'Sawa. Mali ipi, wakati gani, na kuna jambo maalum (ukaguzi wa utii, cheti cha ukaaji, kufuatilia malalamiko)? Nitaandaa na kuweka tayari kwa saini yako.',
    },
    related: ['mwikila.draft.letter', 'mwikila.compliance.anti-graft'],
    visibility: 'PUBLIC',
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    public_description: {
      en: 'Describe the document — "the inspection letter from last September" — and Mr. Mwikila pulls it up with citation.',
      sw: 'Eleza hati — "barua ya ukaguzi ya Septemba mwaka jana" — na Mwikila huitoa pamoja na kumbukumbu.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Two matches from November: the ABC tenancy agreement and the cleaning service contract with TransCo. Which one are you thinking of?',
  ...
  },
  {
    ...
    public_description: {
      ...
      sw: 'Tafuta mfanyakazi, kitengo, mpangaji, muuzaji, mali, mkataba — hata kwa sifa kidogo ("muuzaji aliyepeleka dizeli wiki iliyopita").',
    },
    example_question: {
  ...
  },
  {
    ...
    example_question: {
      en: 'What did we decide about the Masaki Court expansion?',
      sw: 'Tuliamua nini kuhusu upanuzi wa Masaki Court?',
    },
    example_response_pattern: {
      en: 'Decision logged March 18: hold expansion until Q3, contingent on occupancy holding above 90%. The retrospective grade is still pending — want me to update it now?',
      sw: 'Uamuzi ulirekodiwa Machi 18: kushikilia upanuzi hadi robo ya tatu, kulingana na upangishaji kubaki juu ya 90%. Tathmini bado iko hewani — unataka tuisasishe sasa?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    id: 'mwikila.compliance.anti-graft',
    topic: 'compliance',
    user_outcome: 'Owner files anti-corruption / ownership disclosures on time.',
    public_name: {
      en: 'Anti-graft and ownership filings',
      sw: 'Mawasilisho ya umiliki na dhidi ya ufisadi',
    },
    public_description: {
      en: 'Disclosure schedules, beneficial-ownership statements, and conflict logs prepared in the format the anti-corruption authority requires.',
      sw: 'Ratiba za ufichuaji, taarifa za umiliki, na rekodi za migongano zikitayarishwa katika muundo unaohitajika na mamlaka ya kupambana na ufisadi.',
    },
    example_question: {
      en: 'When is the next disclosure filing due?',
      sw: 'Ni lini wasilisho la ufichuaji lijalo linapaswa?',
    },
    example_response_pattern: {
    ...
    related: ['mwikila.compliance.environment', 'mwikila.draft.report'],
    visibility: 'PUBLIC',
  },
  {
    id: 'mwikila.compliance.environment',
    topic: 'compliance',
    user_outcome: 'Owner keeps the environmental file always ready.',
    public_name: {
      en: 'Environmental inspection cycle management',
      sw: 'Usimamizi wa mzunguko wa ukaguzi wa mazingira',
    },
    public_description: {
      en: 'Environmental inspection windows tracked per property, evidence pre-staged, inspection requests filed in the right format.',
      sw: 'Vipindi vya ukaguzi wa mazingira hufuatiliwa kwa kila mali, ushahidi umejiandaa, maombi ya ukaguzi hujazwa katika muundo unaofaa.',
    },
    example_question: {
      en: 'Where am I with the environmental inspection?',
      sw: 'Niko wapi na ukaguzi wa mazingira?',
    },
    example_response_pattern: {
      en: 'Oyster Bay\'s inspection window opens in 12 days; the evidence pack is 80% ready. Masaki Court is good through October. Want to close the Oyster Bay gap now?',
      sw: 'Dirisha la ukaguzi la Oyster Bay linafunguka siku 12; ushahidi uko tayari 80%. Masaki Court iko salama hadi Oktoba. Tufunge pengo la Oyster Bay sasa?',
    },
    related: ['mwikila.compliance.anti-graft', 'mwikila.safety.incident'],
    visibility: 'PUBLIC',
  },
  {
    id: 'mwikila.compliance.transparency',
    topic: 'compliance',
    user_outcome: 'Owner produces a transparency report on demand.',
    public_name: {
      en: 'Transparency reports',
      sw: 'Ripoti za uwazi',
    },
    public_description: {
      en: 'Rent collected, taxes paid, beneficial ownership, related-party dealings — Mr. Mwikila compiles a transparency-grade view across the estate.',
      sw: 'Kodi iliyokusanywa, kodi za serikali, umiliki, miamala ya wahusika — Mwikila hukusanya mwonekano wa uwazi kwa estate yote.',
    },
    example_question: {
      en: 'Can you produce a transparency summary?',
      sw: 'Unaweza kutoa muhtasari wa uwazi?',
    },
    example_response_pattern: {
      en: 'Yes. For the fiscal year, rent collected TZS 184M, corporate tax TZS 89M, three beneficial owners on record. Want it as a one-page summary or the full appendix?',
      sw: 'Ndio. Kwa mwaka wa fedha, kodi iliyokusanywa TZS 184M, kodi ya serikali TZS 89M, wamiliki watatu kwenye rekodi. Unataka muhtasari wa ukurasa mmoja au kiambatisho kamili?',
    },
  ...
  },
  {
    ...
    example_response_pattern: {
      en: 'Q1 export is staged. Rent, arrears, payroll, vendor — all hash-stamped. Should I generate the PDF appendix as well, or just the data file?',
      sw: 'Ripoti ya robo ya kwanza imejiandaa. Kodi, malimbikizo, mishahara, wauzaji — yote yana muhuri. Niandae PDF pia, au faili la data tu?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  // MARKETPLACE (3) — owner moves units to market through a vetted channel.
  // ─────────────────────────────────────────────────────────────────
  {
    id: 'mwikila.marketplace.listing',
    topic: 'marketplace',
    user_outcome: 'Owner lists a unit and gets vetted-applicant offers.',
    public_name: {
      en: 'List a unit for applications',
      sw: 'Tangaza kitengo kwa maombi',
    },
    public_description: {
      en: 'Describe a unit; Mr. Mwikila posts it to vetted applicants, collects offers, and ranks them by rent + payment terms + move-in clarity.',
      sw: 'Eleza kitengo; Mwikila huitangaza kwa waombaji waliothibitishwa, hukusanya matoleo, na huzipanga kwa kodi + masharti ya malipo + uwazi.',
    },
    example_question: {
      en: 'List the May vacancy for applications',
      sw: 'Tangaza nafasi ya Mei kwa maombi',
    },
    example_response_pattern: {
      en: 'Ready. The unit is a 2-bed at Oyster Bay, asking TZS 1.2M/month. I will give vetted applicants 48 hours and rank by net-to-you. Confirm to post?',
      sw: 'Tayari. Kitengo ni cha vyumba 2 Oyster Bay, kodi TZS 1.2M kwa mwezi. Nitawapa waombaji muda wa masaa 48 na kuwapanga kwa kiasi cha kupata. Thibitisha kutangaza?',
    },
  ...
  },
  {
    ...
    public_description: {
      ...
      sw: 'Tazama maombi yanayoshindana yakipangwa kwa kiasi cha kupata, mkataba ukiwa tayari kwenye ombi unalochagua.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Three applications on unit #U-0512. Best net is XYZ at TZS 1.4M/month with a 12-month term. ABC offers TZS 1.45M but only 6 months. Want to accept now or wait for the last applicant?',
      sw: 'Maombi matatu kwa kitengo #U-0512. Bora ni XYZ kwa TZS 1.4M kwa mwezi muda wa miezi 12. ABC anatoa TZS 1.45M lakini miezi 6 tu. Ukubali sasa au usubiri wa mwisho?',
    },
    related: ['mwikila.marketplace.listing', 'mwikila.marketplace.delivery'],
    visibility: 'PUBLIC',
  },
  {
    id: 'mwikila.marketplace.delivery',
    topic: 'marketplace',
    user_outcome: 'Owner closes a letting with move-in + signature + payment tracked.',
    public_name: {
      en: 'Sign move-in and close the letting',
      sw: 'Sahihi kuhamia na kufunga upangishaji',
    },
    public_description: {
      en: 'Move-in checklist, tenant signature, deposit confirmation — Mr. Mwikila threads all three so the cash hits the ledger without manual entry.',
      sw: 'Orodha ya kuhamia, sahihi ya mpangaji, uthibitisho wa amana — Mwikila huviunganisha vyote ili fedha zifikie leja bila kuingiza kwa mkono.',
    },
    example_question: {
      en: 'Close the XYZ letting',
      sw: 'Funga upangishaji wa XYZ',
    },
    example_response_pattern: {
      en: 'Tenant signature received at 14:22, move-in checklist timestamped, deposit confirmation expected within 7 days. I will alert you the moment the M-Pesa receipt clears.',
      sw: 'Sahihi ya mpangaji imefika saa 14:22, orodha ya kuhamia imewekewa muhuri, amana inatarajiwa ndani ya siku 7. Nitakujulisha mara M-Pesa itakapokamilika.',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    example_question: {
      en: 'I need a new maintenance foreman',
      sw: 'Nahitaji foreman mpya wa matengenezo',
    },
    example_response_pattern: {
      en: 'Will do. Property, salary band, must-have certifications (electrical, HVAC), and how soon you need a start date — give me those and I will post + start screening.',
      sw: 'Sawa. Mali, bendi ya mshahara, vyeti vya lazima (umeme, HVAC), na muda wa kuanza — nipe hayo na nitatangaza + kuanza kuchunguza.',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    topic: 'safety',
    user_outcome: 'Incident is reported, investigated, and escalated to the regulator if needed.',
    public_name: {
    ...
    example_response_pattern: {
      en: 'Sorry to hear that. Tell me the name, the property, and what happened — I will open an incident, get the medic dispatched if not already, and start the regulator notice if severity warrants. Is the worker stable?',
      sw: 'Pole sana. Niambie jina, mali, na kilichotokea — nitafungua tukio, kuwapeleka matabibu kama hawajafika, na kuanzisha taarifa kwa wadhibiti kama ni lazima. Mfanyakazi yuko salama?',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    example_question: {
      en: 'Record that I am holding the Masaki Court expansion',
      sw: 'Rekodi kuwa ninashikilia upanuzi wa Masaki Court',
    },
    example_response_pattern: {
      en: 'Logged. The trigger is occupancy below 90%; the alternatives I am noting are phased expansion and zero expansion. We will check back in 90 days. Want to set the review date?',
      sw: 'Imerekodiwa. Kichocheo ni upangishaji chini ya 90%; chaguzi mbadala ninazorekodi ni upanuzi wa hatua na sifuri. Tutaangalia tena siku 90. Uweke tarehe ya kuangalia?',
    },
  ...
  },
  {
    ...
    example_question: {
      en: 'Should I expand Masaki Court now?',
      sw: 'Nipanue Masaki Court sasa?',
    },
    example_response_pattern: {
      en: 'Three paths. Expand now: capex TZS 320M, payback 18 months at current rent levels. Phased: capex TZS 120M now plus 200M in Q3 if occupancy holds. Hold: zero capex, lose first-mover edge. Which constraint matters most — capex, payback speed, or risk?',
  ...
  },
  {
    ...
    example_response_pattern: {
      en: 'From the ABC lease #L-0418 ledger entry on May 14. Tap the citation to see the exact row. Want me to pull the upstream invoice as well?',
      sw: 'Kutoka kwenye kumbukumbu ya leja ya mkataba wa ABC #L-0418 ya Mei 14. Bonyeza kumbukumbu uone mstari halisi. Niletee ankara pia?',
    },
  ...
  },
  {
    ...
    example_response_pattern: {
      en: 'No. Your data is yours. I keep it scoped to your estate end-to-end. The only shared knowledge is the public property playbook — regulations, tenancy codes, market basics.',
      sw: 'Hapana. Data yako ni yako. Naihifadhi ndani ya estate yako mwanzo hadi mwisho. Inayoshirikishwa ni mwongozo wa mali wa umma tu — kanuni, misimbo ya upangaji, soko la msingi.',
    },
  ...
  },
  {
    ...
    topic: 'multi-scale',
    user_outcome: 'Owner gets advice tuned to their actual scale (single unit to multi-property portfolio).',
    public_name: {
      en: 'Scale-aware from single unit to portfolio',
      sw: 'Kuzingatia ukubwa kutoka kitengo kimoja hadi portfolio',
    },
    public_description: {
      en: 'Mr. Mwikila tunes depth, vocabulary, and recommendations to your scale — a single-unit landlord hears one thing, a multi-property portfolio hears another.',
      sw: 'Mwikila hurekebisha kina, msamiati, na mapendekezo kwa ukubwa wako — mwenye kitengo kimoja husikia jambo moja, portfolio ya mali nyingi husikia jingine.',
    },
    example_question: {
      en: 'Will this work for a small single-unit rental?',
      sw: 'Hii itafanya kazi kwa upangishaji mdogo wa kitengo kimoja?',
    },
    example_response_pattern: {
      en: 'Yes. I adjust the depth and the alerts to single-unit scale. If you grow, the cockpit grows with you — same chat, more views.',
      sw: 'Ndio. Ninarekebisha kina na onyo kwa ukubwa wa kitengo kimoja. Ukikua, dashibodi inakua nawe — gumzo lile lile, mwonekano zaidi.',
    },
  ...
  },
  {
    ...
    public_name: {
      ...
      sw: 'Mwonekano wa estate ya mali nyingi na mikataba mingi',
    },
    public_description: {
      en: 'Roll-ups across every property, lease, and subsidiary in the estate, with drill-down to any single entity.',
      sw: 'Mikusanyo ya mali, mikataba, na kampuni tanzu zote, ikiwa na uwezo wa kuchimba kwa kitu kimoja.',
    },
    example_question: {
    ...
    example_response_pattern: {
      en: 'Yes. Estate view rolls them up — total revenue, rent, headcount, open risks — and you can drill into any one with a tap.',
      sw: 'Ndio. Mwonekano wa estate huzikusanya — mapato, kodi, idadi ya wafanyakazi, hatari — na unaweza kuchimba moja kwa bonyezo.',
    },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    public_description: {
      en: 'I am Mr. Mwikila, BossNyumba\'s AI Real Estate Managing Director. I support owners running property estates across single-unit to portfolio scale.',
      sw: 'Mimi ni Bwana Mwikila, Mkurugenzi Mtendaji wa AI wa Mali wa BossNyumba. Ninasaidia wamiliki wanaoendesha estate za mali kuanzia kitengo kimoja hadi portfolio.',
    },
    example_question: {
      en: 'Who are you?',
      sw: 'Wewe ni nani?',
    ...
    example_response_pattern: {
      en: 'I am Mr. Mwikila — BossNyumba\'s AI Real Estate Managing Director. I work from what you tell me, what you give me, and the playbooks we build together. What would you like to do first?',
  ...
  },
  {
    ...
    public_name: {
      en: 'I am BossNyumba\'s purpose-built real estate AI',
      sw: 'Mimi ni AI ya BossNyumba iliyojengwa kwa ajili ya mali',
    },
    public_description: {
      en: 'I am BossNyumba\'s real estate MD AI — purpose-built for property estates. I am not a general-purpose chatbot, and I work from your records, our chats, and the shared playbook.',
    ...
    example_response_pattern: {
      en: 'No. I am Mr. Mwikila — BossNyumba\'s real estate MD AI, purpose-built for owners like you. I do not work like a general chatbot. Want me to show you something concrete?',
