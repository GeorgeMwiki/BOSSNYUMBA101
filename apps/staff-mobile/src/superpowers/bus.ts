/**
 * In-module pub/sub bus for staff-mobile superpowers. Same shape as
 * the BossNyumba tenant-mobile / estate-manager variants so a future
 * shared `@bossnyumba/superpowers-mobile` package can replace this
 * verbatim.
 */
