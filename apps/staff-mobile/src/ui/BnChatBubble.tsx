...
export type BnChatBubbleRole = 'user' | 'ai' | 'system'

export interface BnChatBubbleProps {
  readonly role: BnChatBubbleRole
...
/**
 * BossNyumba AI chat bubble — gold-gradient top accent on AI replies,
 * deep gold fill on user bubbles. The web BossNyumba ChatPanel applies the
