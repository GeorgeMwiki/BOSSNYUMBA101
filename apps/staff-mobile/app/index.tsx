...
export default function IndexRoute(): JSX.Element {
  ...
  if (!ready) {
    return <BnSplash wordmark="BOSSNYUMBA" tagline={tagline} showSpinner />
  }
  if (!user) {
