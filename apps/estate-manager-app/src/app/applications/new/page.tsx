  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await applicationsService.create({
        ...
        applicantAddress: formData.get('applicantAddress') as string || undefined,
        type: formData.get('type') as string,
        assetType: formData.get('assetType') as string || undefined,
        requestedLocation: formData.get('requestedLocation') as string || undefined,
        requestedSize: formData.get('requestedSize') as string || undefined,
        proposedRentAmount: formData.get('proposedRentAmount') ? Number(formData.get('proposedRentAmount')) : undefined,
        leaseTermMonths: formData.get('leaseTermMonths') ? Number(formData.get('leaseTermMonths')) : undefined,
        purposeOfUse: formData.get('purposeOfUse') as string || undefined,
        letterReceivedDate: formData.get('letterReceivedDate') as string || undefined,
        letterReceivedAt: formData.get('letterReceivedAt') as string || undefined,
          ...
          <div className="card p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="date" name="letterReceivedDate" className="input" required />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">Received At *</label>
                <select name="letterReceivedAt" className="input" required>
            ...
            <div>
              ...
              <select name="receivingStationId" className="input">
          ...
          <div className="card p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2">
                ...
                <input type="text" name="applicantName" className="input" placeholder="Full name" required />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">Phone</label>
                <input type="tel" name="applicantPhone" className="input" placeholder="+255..." />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">Email</label>
                <input type="email" name="applicantEmail" className="input" placeholder="email@example.com" />
              </div>
            </div>
            <div>
              <label className="block text-sm text-gray-600 mb-1">Address</label>
              <input type="text" name="applicantAddress" className="input" placeholder="Applicant address" />
            </div>
          </div>
          ...
          <div className="card p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select name="assetType" className="input">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" name="requestedLocation" className="input" placeholder="Location description" />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">Requested Size</label>
                <input type="text" name="requestedSize" className="input" placeholder="e.g., 500 sqm" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm text-gray-600 mb-1">Proposed Rent (TZS/month)</label>
                <input type="number" name="proposedRentAmount" className="input" placeholder="0" />
              ...
              <div>
                ...
                <input type="number" name="leaseTermMonths" className="input" placeholder="12" />
              </div>
            </div>
            <div>
