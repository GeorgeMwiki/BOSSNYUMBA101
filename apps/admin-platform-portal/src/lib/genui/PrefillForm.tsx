...
/**
 * 5. prefill-form — TanStack Form + Zod with optional diff popover.
 *
 ...
 *
 * The schemaJson arrives as JSON Schema Draft-7. For initial impl we
 * use a generic key→input renderer; when @tanstack/react-form is
 * installed we can swap to its bindings without touching the
 * AdaptiveRenderer.
 */
