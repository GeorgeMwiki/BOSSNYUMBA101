...
/**
 * 2. data-table — TanStack Table v8 with sort + filter + CSV export.
 *
 ...
 *
 * For the initial implementation we render a simple sortable HTML
 * table. When `@tanstack/react-table` is installed it can be swapped
 * in via a one-line factory change without touching the AdaptiveRenderer.
 */
