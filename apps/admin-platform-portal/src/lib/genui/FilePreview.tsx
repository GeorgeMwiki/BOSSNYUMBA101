 ...
 *   - react-pdf ^9.1.0
 *
 * Loading strategy: dynamic + ssr:false. react-pdf needs Worker
 * access only available in the browser.
 */
...
const PdfInner = dynamic<any>(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  () => import('./PdfInner.js').then((m: any) => m.PdfInner),
  {
    ssr: false,
