    ...
    if (
      ...
      return {
        ...
        content: [
          {
            type: 'text',
            text: 'firs: args.tenantId does not match verified _meta.verifiedTenantId',
          },
        ],
      };
    }
    ...
    if (!tenantId) {
      return {
        ...
        content: [
          {
            type: 'text',
            text: 'firs: missing tenantId — required in args.tenantId or request._meta.tenantId/verifiedTenantId',
          },
        ],
      };
    }
